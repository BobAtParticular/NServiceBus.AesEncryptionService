namespace NServiceBus.AcceptanceTests.Encryption
{
    ...
    public class When_using_Aes_with_multikey : NServiceBusAcceptanceTest
    {
        ...
        public class Sender : EndpointConfigurationBuilder
        {
            public Sender()
            {
                EndpointSetup<DefaultServer>(builder => builder.AesEncryptionService("1st", Encoding.ASCII.GetBytes("gdDbqRpqdRbTs3mhdZh9qCaDaxJXl+e6")))
        ...
        public class Receiver : EndpointConfigurationBuilder
        {
            public Receiver()
            {
                ...
                EndpointSetup<DefaultServer>(builder => builder.AesEncryptionService("2nd", keys, expiredKeys));
            }
