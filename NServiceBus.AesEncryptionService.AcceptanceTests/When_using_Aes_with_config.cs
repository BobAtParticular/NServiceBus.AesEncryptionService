...
namespace NServiceBus.AesEncryptionService.AcceptanceTests
{
    public class When_using_Aes_with_config : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class Endpoint : EndpointConfigurationBuilder
        {
            public Endpoint()
            {
                EndpointSetup<DefaultServer>(builder => builder.AesEncryptionService());
            }
        ...
        public class ConfigureEncryption : IProvideConfiguration<EncryptionServiceConfig>
        {
            public EncryptionServiceConfig GetConfiguration()
            {
                return new EncryptionServiceConfig
                {
                    KeyIdentifier = "1st",
