...
namespace NServiceBus.AesEncryptionServiceTests
{
    ...
    public class AesEncryptionServiceTest
    {
        ...
        public void Should_throw_for_invalid_key()
        {
            ...
            var exception = Assert.Throws<Exception>(() => new TestableAesEncryptionService("keyid", invalidKey, new List<byte[]>()));
        ...
        public void Should_throw_for_invalid_expired_key()
        {
            ...
            var exception = Assert.Throws<Exception>(() => new TestableAesEncryptionService("keyid", validKey, expiredKeys));
        ...
        class TestableAesEncryptionService : AesEncryptionService
        {
            public TestableAesEncryptionService(
            ...
            protected override void ConfigureIV(AesManaged aes)
            {
